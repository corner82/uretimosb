...
class FactoryServiceNpkSaver  implements FactoryInterface{
...
//            $statement->bindValue(':publicKey', $publicKey, \PDO::PARAM_STR);
            $statement->bindValue(':npk', $npk, \PDO::PARAM_STR);
