$(document).ready(function() { 
        ...
        $('#tt_tree').tree({
         ...
         $( window ).resize(function() {
            $('#tt_grid_cmpn_prod').datagrid('resize');
            $('#tt_grid_dynamic').datagrid('resize');
        });
    
          // firma ürün bilgileri grid
            $('#tt_grid_cmpn_prod').datagrid({
            ...
            columns:
                    [[
                        ...
                        {field:'product_name',title:'Ürün',width:300,sortable:true},
                        {field:'product_description',title:' Ürün Tanımı',width:500},
                    ]]   
          });
                ...
                onDblClickRow : function (index, row) {
                    $.ajax({
                        url : '../slimProxyEkoOstim/SlimProxyBoot.php?url=getCompany_companyProd',   
                        data : {
                                id : row.id
                        },
                        type: 'GET',
                        ...
                        success: function(data, textStatus, jqXHR) {
                            ...
                            $('#tt_grid_cmpn_prod').datagrid('reload'); 
                            if(!data['notFound']) {
                ...
                columns:
                    [[
                        ...
                        {field:'tax_office',title:'Vergi Dairesi', width:100},
                        {field:'tax_no',title:' Vergi Numarası',sortable:true,width:100},
                        {field:'sgk_sicil_no',title:'SGK Sicil No', width:100}, 
                    ]]   
          });
