$(document).ready(function() { 
        ...
        $('#formCompany').submit(function(e) {
                ...
                if ($("#formCompany").validationEngine('validate')) {
                    ...
                    //alert('test2');  
                    $.ajax({
                        url : '../slimProxyEkoOstim/SlimProxyBoot.php?url=setFirmInfoBulk_company',   
                        data : {
                                form : vars,
                                id : row.sirket_id
                        },
                        ...
                        success: function(data, textStatus, jqXHR) {
                            console.log(data);
                             $('#firmaIletisim').unblock();
                             $('#firmaCalisan').unblock();
                             $('#test').unblock();
            ...
            return $("#tt_grid_other_machinery_Main").width();  
                ...
                columns:
                        [[
                            ...
                            {field:'fanafa',title:'Faaliyet Alan.',width:300},
                            {field:'kategori_id',title:'Kategori Bil.',width:300},
                            {field:'kume_bilgisi',title:' Küme Bilgisi',width:300,sortable:true},
                            {field:'kumeye_dahil_mi',title:'Kümeye Dahilmi',width:100},
                            {field:'csayisi',title:'Çalışan Say.',width:300},
                            {field:'isayisi',title:'İşçi Say.',width:300,sortable:true},
