    ...
    if(rowCompany == null || rowWorkFlow == null || rowProcess == null
       || (rowCompany.firm_name!==rowWorkFlow.firm_name || rowCompany.firm_name!== rowProcess.firm_name)) {
        ...
        $.ajax({
            url : '../slimProxyEkoOstim/SlimProxyBoot.php',   
            data : {
                    firm_id : rowCompany.id,
                    workflow_def_id : rowWorkFlow.id,
                    process_id : rowProcess.id,
                    url : 'setFirmWorkflowProcess_company',
            },
            type: 'GET',
            dataType : 'json',
            success: function(data, textStatus, jqXHR) {
...
$(document).ready(function() { 
       ...
       /* $('#tt_tree').tree({
        ...
        onSelect : function (index, row){
            $('#workFlowSelectedTitle').html(row.workflow_name+' sürec\'inde işlem yapmaktasınız');  
        },
        singleSelect:true,
        pagination : true,
        collapsible:true,
        ...
        $('#tt_grid_cmpn_process').datagrid({
        onSelect : function (index, row){
            $('#processSelectedTitle').html(row.process_name+' prosess\'inde işlem yapmaktasınız');  
        },
        singleSelect:true,
        pagination : true,
        collapsible:true,
        ...
        onDblClickRow : function (index, row) {
            $('#workFlowSelectedTitle').html('Lütfen süreç seçiniz...');
            $('#processSelectedTitle').html('Lütfen proses seçiniz...');
            
            $('#companySelectedTitle').html(row.firm_name+' firmasında işlem yapmaktasınız');
