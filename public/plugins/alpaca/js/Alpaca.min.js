            ...
            t.registerView({
                ...
                messages: {
                    "tr_TR": {
                        ...
                        disallowValue: "{0} değer geçersizdir.",
                        invalidValueOfEnum: "Bu alanda aşağıdakilerden birini almak gereklidir : {0}. [{1}]",
                        notEnoughItems: "En düşük eleman sayısı {0}",
                        tooManyItems: "Gereğinden fazla eleman seçilmiştir {0}",
                        valueNotUnique: "Değerler benzersizdir",
                        notAnArray: "Liste Değildir.",
                        invalidDate: "Tarih biçimi doğru değildir {0}",
                        invalidEmail: "Geçersiz E-posta adresi, örn: info@cloudcms.com",
                        stringNotAnInteger: "Bu değer bir tam sayı değildir.",
                        invalidIPv4: "IPv4 adresi yanlıştır, örn: 192.168.0.1",
                        stringValueTooSmall: "Girilen değer aşırı küçüktür {0}",
                        stringValueTooLarge: "Girilen değer aşırı büyüktür {0}",
                        stringValueTooSmallExclusive: "Girilen değer {0} den daha fazla olmalıdır. ",
                        stringValueTooLargeExclusive: "Girilen değer {0} den daha az olmalıdır. ",
                        stringDivisibleBy: "Girilen değer {0} değerine bölünebilir olmalıdır ",
                        stringNotANumber: "Bu değer bir sayı değildir. ",
                        invalidPassword: "Yanlış şifre.",
                        invalidPhone: "Yanlış telefon numarası, örn: (123) 456-9999",
                        invalidPattern: "Alan formatına uygun değildir {0}",
                        stringTooShort: "Bu alan en az {0} karakter içermelidir",
                        stringTooLong: "Bu alan en fazla {0} karakter içermelidir"
                    }
                }
            })
        }(jQuery),        
